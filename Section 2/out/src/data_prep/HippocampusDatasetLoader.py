...
def LoadHippocampusData(root_dir, y_shape, z_shape):
    ...
    image_dir = os.path.join(root_dir, '/home/workspace/images')
    label_dir = os.path.join(root_dir, '/home/workspace/labels')
    ...
    for f in images:
        ...
        # ANSWER: to make sure class label int to model
